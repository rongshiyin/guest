...
class EventManageTest(TestCase):
    ...
    def setUp(self):
        ...
        address='beijing',start_time=datetime(2019,10,10,14,0,0))
        self.c = Client()
...
class GuestManageTest(TestCase):
    #''' 嘉宾管理 '''
    def setUp(self):
        Event.objects.create(id=1,name="xiaomi9",limit=2000,
        address='beijing',status=1,start_time=datetime(2019,11,10,14,0,0))
...
class SignIndexActionTest(TestCase):
    ...
    def setUp(self):
        ...
        status=1,start_time='2019-9-19 12:30:00')
        Event.objects.create(id=2,name="oneplus4",limit=2000,address='shenzhen',
        status=1,start_time='2019-10-11 12:30:00')
        Guest.objects.create(realname="alen",phone=18611001100,
        email='alen@mail.com',sign=0,event_id=1)
